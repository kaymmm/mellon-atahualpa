...
<?php if ( is_front_page() ) {
	...
	wp_register_script( 'resizeimages', 'http://kaymmm.github.com/mellon-atahualpa/science/js/resize.min.js', array('jquery','jquery.cycle','jquery.imagesloaded','scaleimage'),null,false ); 

...
<?php if ( is_front_page() ) {
	...
	wp_register_script( 'resizeimages', 'http://kaymmm.github.com/mellon-atahualpa/pcp/js/resize.min.js', array('jquery','jquery.cycle','jquery.masonry','jquery.imagesloaded','scaleimage'),null,false ); 
